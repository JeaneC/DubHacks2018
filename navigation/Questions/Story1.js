...
import { updateStory } from '../../store/actions';
      ...
      <View style={styles.container}>
        ...
        >
          ...
          <TouchableOpacity
            ...
            onPress={async () => {
              await this.props.updateStory(this.state.value);
              this.props.navigation.navigate('People1');
            }}
          >
...
const mapStateToProps = state => {
  ...
  let header1 = 'Can you describe what happened to you?';
  if (language == 1) {
    ...
    header1 = 'Pouvez-vous décrire ce qui vous est arrivé?';
  }
