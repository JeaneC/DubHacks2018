...
import { updateFeelsNow } from '../../store/actions';
      ...
      <View style={styles.container}>
        ...
        >
          ...
          <TouchableOpacity
            ...
            onPress={async () => {
              await this.props.updateFeelsNow(this.state.value);
              this.props.navigation.navigate('Contact1');
            }}
          >
